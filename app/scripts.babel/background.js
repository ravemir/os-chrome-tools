...
chrome.runtime.onInstalled.addListener(details => {
  console.log('previousVersion', details.previousVersion);
																						              ...
																						              // Find the "Check all eSpaces" link and its div
																							              //var buttonDiv = document.querySelector(".Page_Content table:contains('Associate Components with Solution') tr td div a:contains('check all eSpaces')")[0].parentNode;
